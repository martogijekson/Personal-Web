    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          imageUrl: "weddingwebsite",
          status:
            "Wedding Website is a web application project that has a responsive display, which can be used to create digital wedding invitations.",
          tech: "Laravel 5, Bootstrap",
          github: "https://github.com/martogijekson",
          demo: "null",
        },
        {
          id: 3,
          name: "PortoFolio",
          imageUrl: "portofoliov1",
          status:
            "PortoFolio is a simple web application project using HTML & CSS, which aims to complete the web programming course assignment.",
          tech: "HTML, CSS",
          github: "https://github.com/martogijekson",
          demo: "https://martogijekson.000webhostapp.com/",
        },
        {
          id: 4,
          name: "Minimarket Cashier Application",
          imageUrl: "aplikasikasir",
          status:
            "A minimarket cashier application project that has a CRUDS feature and can scan items using a mobile scanner.",
          tech: "Vb.net, MySQL",
          github: "null",
          demo: "https://youtu.be/fbfZdRN3jHY?si=VgthAtvHg9-UBEFi",
        },
        {
          id: 5,
          ...
          imageUrl: "Iotprojek",
          status:
            "Smart Home Lamp is the final project of the IoT course, aimed at turning the lights on and off without any distance limits using telegram.",
          tech: "Arduino IDE, ESP 8266",
          github: "null",
          demo: "https://youtu.be/msvvDV5RP2A?si=MtJR4k8HOC093vhi",
        },
        {
          id: 6,
          ...
          imageUrl: "cruds",
          status:
            "A Final Project for the Object-Oriented Programming Course, with CRUDS features using Apache NetBeans and MySQL database.",
          tech: "Java, MySQL",
          github: "https://github.com/martogijekson",
          demo: "null",
        },
